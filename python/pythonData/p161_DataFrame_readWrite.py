...
print('\n김유신 include data read of series')
result = myframe.loc['김유신']
print(type(result))
print(result)
print('-' * 50)

print('\n이순신, 김유신 include data read of DataFrame')
...
print('\n이순신, 광주 실적 include data read of DataFrame')
result = myframe.loc[['이순신'], ['광주']]
print(type(result))
print(result)
print('-' * 50)

print('\n이순신, 강감찬 / 광주, 목포 실적 include data read of DataFrame')
result = myframe.loc[['이순신', '강감찬'], ['광주', '목포']]
print(type(result))
print(result)
print('-' * 50)

print('\n이순신 ~ 강감찬 / 서울 ~ 목포 실적 include data read of DataFrame')
result = myframe.loc['이순신':'강감찬', '서울':'목포']
print(type(result))
print(result)
print('-' * 50)

print('\n이순신 ~ 광해군 / 부산 실적 include data read of DataFrame')
